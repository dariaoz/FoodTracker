...
public class ProductService : IProductService
{
    ...
    public async Task<Product> CreateAsync(Product product, CancellationToken ct = default)
    {
        ...
        await _indexing.SyncIndexAsync(() => _searchContext.Products.IndexAsync(created, ct), $"index product {created.Id}", ct);
        return created;
    }
    ...
    public async Task DeleteAsync(string id, CancellationToken ct = default)
    {
        ...
        await _indexing.SyncIndexAsync(() => _searchContext.Products.DeleteAsync(id, ct), $"delete product {id}", ct);
    }
}
