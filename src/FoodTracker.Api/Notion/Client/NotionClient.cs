...
namespace FoodTracker.Api.Notion.Client;
...
public class NotionClient : INotionClient
{
    ...
    {
        var body = filter is null ? new { } : (object)new { filter };
        string response = await PostAsync($"databases/{databaseId}/query", body, ct);
